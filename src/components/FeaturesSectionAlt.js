...
const FeaturesSectionAlt = () => {
    return (
        <div id="about" className="w-screen min-h-screen flex flex-col items-center gap-16 py-12 lg:py-[120px]">
            ...
            <div className="flex flex-col items-center justify-center gap-3 w-full px-3 w-full md:max-w-[1080px]">
                <div className="flex flex-col md:flex-row items-center justify-center w-full flex-wrap lg:flex-nowrap gap-4">
                    <CourseAlt />
                    <PricingCard />
                    <MapAlt />
                </div>
