...
const ScrollSection = () => {
    return (
        <div id="facilities" className="w-screen flex flex-col items-center gap-16 py-12 lg:py-[120px] bg-[#101012]">
            ...
            <div className="w-full max-w-[1080px] px-4 grid grid-cols-1 lg:grid-cols-2 gap-0 lg:gap-16">
                ...
                <div className="flex flex-col">
                    <div className="h-[600px] max-h-screen sticky top-24 p-8 flex flex-col justify-center" style={{background: 'linear-gradient(180deg, #10101200 0%, #101012ff 20%, #101012ff 80%, #10101200 100%)'}}>
