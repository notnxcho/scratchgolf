const Ball = ({ className }) => {
    return (
        <div className={`flex flex-col gap-3 min-h-[400px] lg:h-[480px] bg-white/10 lg:min-w-[400px] w-min rounded-[12px] p-5 lg:p-8 flex-grow shadow-[0_4px_16px_0_rgba(0,0,0,0.04)] ${className || ''}`}>
