const Card = ({title, description, src}) => {
    return (
        <div className="flex flex-col items-center justify-center flex-basis-50 lg:min-w-[256px] h-[360px] rounded-[12px] flex-grow xl:flex-grow-0 relative overflow-hidden border-[5px] border-white shadow-[0_4px_16px_0_rgba(0,0,0,0.04)]">
